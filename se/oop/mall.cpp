...
using namespace std;
    class item
 {
     ...
     void item::add()
   {
    ...
    cout<<"enter category name=";
    cin>>category;
    cout<<"how many item do you want to add =";
    cin>>n;
    for(i=temp;i<n;i++)
    {
      cout<<"enter name of the item=";
     ...
     void item::remove()
  {
    ...
    void item :: catego_amount()
    {
    cout<<"under the "<<category<<" category the total price of the items are="<<sum<<'\n'<<'\n';
    }
    void item::error1()
    {
      cout<<"FIRST YOU NEED TO INSERT ITEAM";
      cout<<'\n'<<'\n';
    }
    void item::initial_task()
    {
  cout<<"What do you want to do ?"<<'\n';
  cout<<"1.if you want to insert press 1"<<'\n';
  cout<<"2.if you want to add press 2"<<'\n';
  cout<<"3.if you want to display press 3"<<'\n';
  cout<<"4.if you want to search press 4"<<'\n';
  cout<<"5.if you want to remove press 5"<<'\n';
  cout<<"6.if you want to see the total price press 6"<<'\n';
  cout<<"7.if you want to exit press 0"<<'\n';
    }
    int item::function1()
    {
    int a1;
     ...
     case 1:
      ...
      case 2:
        ...
        break;}
         ...
         {
           cout<<"how many category do you want to add=";
           cin>>n;
           for(j=0;j<n;j++)
            {
             t[x].add();
